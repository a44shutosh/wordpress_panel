...
const logger = new (winston.Logger)({
    ...
    transports: [
        ...
        new (winston.transports.File)({
            ...
            label          : config.get('logging:label'),
            name           : 'log_file',
            filename       : constant.path.log + 'newsbytes-' + nodeEnv + '-' + moment().format('YYYY_MM_DD') + '.log',
            handleException: true,
            json           : false,
            maxSize        : 52428800,
            maxFiles       : 10,
...
const databaseLogger = new (winston.Logger)({
    ...
    transports: [
        new (winston.transports.File)({
            ...
            label          : config.get('logging:label'),
            name           : 'error_file',
            filename       : constant.path.log + 'newsbytes-' + nodeEnv + '-' + moment().format('YYYY_MM_DD') + '.database.error.log',
            handleException: true,
            json           : false,
            maxSize        : 52428800,
            maxFiles       : 10,
...
const writeLogInfo = (arr) => {
   return logger.info(
       arr[0],
       arr[1] && arr[1],
//       arr[2] && (nodeEnv !==  'production' ? arr[2] : JSON.stringify(arr[2]))
